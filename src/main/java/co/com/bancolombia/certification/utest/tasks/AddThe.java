...
public class AddThe implements Task {
    ...
    public AddThe(List<LogInInformation> logInInformation) {
    ...
    public static AddThe logInInformation(List<LogInInformation> dataList) {
        return instrumented(AddThe.class, dataList);
    }
}
