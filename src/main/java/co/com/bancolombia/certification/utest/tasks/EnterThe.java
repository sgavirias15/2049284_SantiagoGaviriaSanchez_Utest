...
import static co.com.bancolombia.certification.utest.userinterfaces.SignInCredentials.TXT_CONFIRM_PASS;
...
public class EnterThe implements Task {
    ...
    public EnterThe(List<SignInInformation> signInInformationList) {
    ...
    public static EnterThe informationUpToStepFour(List<SignInInformation> dataList) {
        return instrumented(EnterThe.class, dataList);
    }
}
