...
public class Fill implements Task {
    ...
    public Fill(List<SignInInformation> signInInformationList) {
    ...
    public static Fill credentials(List<SignInInformation> dataList) {
        return instrumented(Fill.class, dataList);
    }
}
